...
## Open Questions
- Final image not yet generated — waiting on either the Claude-in-Chrome extension reconnecting (to drive Gemini/ChatGPT) or an OpenAI API key from the user
